...
class Colorate:
    ...
    7 functions:
        ...
        Dynamic colors:
            ...
            FadeByColors()          |           fade a text with colors you want (ex: [green, blue, yellow, orange])
    ...
    def FadeByColors(content: str, colors: list):
        fades = []
        for color in colors:
            try:
        ...
        for line in content.splitlines():
            for letter in list(line):
                final += f'{final_colors[phs_number]}{letter}'
                if phs_number == 0:
                    phs_mode = True
                elif phs_number == len(final_colors) - 1:
                    phs_mode = False
                if not phs_mode:
                    phs_number -= 1
                else:
